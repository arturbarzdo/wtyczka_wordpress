<?php 
	...
	Description: Tbela z wyszukiwaniem i pginacją dla nzoz
	Version: 1.0
	Author: Artur Barzdo
	*/
...
//	function enqueue(){
//		wp_enqueue_style('boot',plugins_url('/public/css/bootstrap.min.css',__FILE__ ));
//	
//	}
//		
...
<td>15,00 zł</td>
			...
			<div class="panel panel-default naglowek">
				...
				<div class="panel-heading naglowek row">
					<a href="#roz3" data-toggle="collapse" data-parent="#according">
						<h2>
							<div class="col-md-4 col-lg-4">
								<span class="glyphicon glyphicon-plus-sign" aria-hidden="true"></span>
							</div>
			...
			<div id="roz3" class="panel-cllapse collapse">
									<div class="panel-body">
        ...
        <tbody>
   			...
   			<?= '<script src="'.plugins_url( '/public/js/jstab2.js', __FILE__ ).'"></script>';?>
